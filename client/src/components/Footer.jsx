        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link to="/guide" className="hover:text-white">User Guide</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><Link to="/aml" className="hover:text-white">AML Policy</Link></li>
              <li><Link to="/dispute" className="hover:text-white">Dispute Resolution</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="mailto:support@timbuktu.exchange" className="hover:text-white flex items-center">
